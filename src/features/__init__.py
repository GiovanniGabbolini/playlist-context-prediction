...
The features are functions that have one parameter, but can output multiple objects, organized in lists.

Notice:
- A feature depends only on the node which is passed as an argument.
